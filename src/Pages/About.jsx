  ...
  return (
    <Layout>
      <div className="page-transition pt-16">
        {/* Hero Section */}
        <section className="min-h-[25vh] flex flex-col items-center justify-center relative bg-secondary">
          <div className="container mx-auto px-4 py-24 text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">About Khet connect</h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto">
              Your trusted source for premium quality organic grains since 2024.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Khet connect was founded in 2024 with a simple mission: to provide high-quality organic grains to health-conscious consumers while supporting sustainable farming practices.
                </p>
                <p className="text-muted-foreground mb-4">
